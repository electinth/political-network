<template>
  <div id="Inpower" class="my-16">
    <span class="body2" id="header" v-if="$mq != 'mobile'">
      ...
      <p>
        และหลายตระกูลที่คว้าตำแหน่ง นายก อบจ. ยังมีความสัมพันธ์เครือญาติกับ
        สภาใหญ่
      </p>
    </span>
    <div v-if="$mq === 'mobile'" class="w-9/12 mx-auto">
      ในการเลือกตั้ง อบจ. ที่ผ่านมา (พ.ศ. 2563) หลายตระกูล คว้าตำแหน่งทั้ง นายก
      อบจ. และ สภา อบจ. ในสมัยเดียวกัน และหลายตระกูลที่คว้าตำแหน่ง นายก อบจ.
      ยังมีความสัมพันธ์เครือญาติกับ สภาใหญ่
    </div>
    <p class="w-6/12 mx-auto mt-3 body5 md:w-full">
      *พิจารณาจาก ครม. และ ส.ส. เขต ที่มีความเกี่ยวข้องกับพื้นที่จังหวัดเดียวกัน
    </p>
    <div
      id="chart"
