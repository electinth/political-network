<template>
  <div class="pt-16 bg-white">
    ...
    {{ type === 'surname-cluster'
            ? '  หมายเหตุ: คำนวณจากจำนวนครั้งที่แต่ละตระกูลได้รับ เลือกเป็นส.ส.เขตจังหวัดนั้น ในช่วงปี 2535-2563 (ชุด 48-62)'
            : '  หมายเหตุ: คำนวณจากจำนวนครั้งที่แต่ละพรรคได้รับ เลือกเป็นส.ส.เขตจังหวัดนั้น ในช่วงปี 2535-2563 (ชุด 48-62)'
        }}
